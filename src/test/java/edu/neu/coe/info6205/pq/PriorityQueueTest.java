...
public class PriorityQueueTest {
    ...
    public void testUnordered1() {
        ...
        binHeap[2] = "B";
        boolean max = false;
        PriorityQueue<String> pq = new PriorityQueue<>(max, binHeap, 1, 2, Comparator.comparing(String::toString), false);
    ...
    public void testSwimUp0() {
        ...
        PriorityQueue<String> pq = new PriorityQueue<>(true, binHeap, 0, 2, Comparator.comparing(String::toString), true);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testSwimUp1() {
        ...
        PriorityQueue<String> pq = new PriorityQueue<>(true, binHeap, 1, 2, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
