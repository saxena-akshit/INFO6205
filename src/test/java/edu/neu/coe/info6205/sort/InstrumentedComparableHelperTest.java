...
public class InstrumentedComparableHelperTest {
    ...
    public void testMergeSortMany() {
        ...
        try (Sort<Integer> s = new MergeSort<>(helper)) {
            ...
            final Statistics statistics = statPack.getStatistics(InstrumentedComparableHelper.COMPARES);
            System.out.println(statistics);
            final int compares = statPack.getCount(InstrumentedComparableHelper.COMPARES);
    ...
    public static void beforeClass() {
        config = Config.setupConfig("true", "true", "0", "10", "1", "");
    }
